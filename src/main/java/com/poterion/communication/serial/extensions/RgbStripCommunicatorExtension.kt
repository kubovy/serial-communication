 ...
 */
class RgbStripCommunicatorExtension<ConnectionDescriptor>(
	 ...
	 * @see MessageKind.RGB
	 */
	fun sendRgbStripConfiguration(num: Int, pattern: RgbPattern, color: RgbColor, delay: Int, min: Int, max: Int,
